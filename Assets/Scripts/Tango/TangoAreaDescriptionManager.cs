...
{
    public class TangoAreaDescriptionManager : MonoBehaviour
    {

        public void Init()
        {
            // Determine if there exists an area description for your area (make it manually clickable)
            // Set the area description manager to learning mode if applicable
            // Start learning, if applicable
            // Finish learning
            // Inform user of status
            // Load up the room area in the cache
            // Activate UI buttons for user to do whatever they want to...
            //    }
            ...
            //        {
            //        AreaDescription.Metadata m = new AreaDescription.Metadata();
            //        m.
